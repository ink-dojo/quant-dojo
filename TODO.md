...
- [x] **A 路第一步 rev 2: 龙虎榜 net_rate event study (Issue #55) + utils/event_study.py 抽框架**
      `journal/lhb_t1_event_study_20260429.md`
      simplify review 修了 3 个 correctness bug + 抽通用 framework 给后续候选用.
...
- [x] **A 路第二候选: 回购预案 event study (Issue #57)**
